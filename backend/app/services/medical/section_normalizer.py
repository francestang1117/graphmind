...
_ALIASES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("clinical recommendations", (MedicalSectionType.RECOMMENDATIONS.value,)),
    ("key recommendations", (MedicalSectionType.RECOMMENDATIONS.value,)),
    ("guideline recommendations", (MedicalSectionType.RECOMMENDATIONS.value,)),
    ("quality of evidence", (MedicalSectionType.EVIDENCE.value,)),
    ("evidence summary", (MedicalSectionType.EVIDENCE.value,)),
    ("implementation considerations", (MedicalSectionType.IMPLEMENTATION.value,)),
    ...
    ("aim", (MedicalSectionType.SCOPE.value,)),
    ...
    ("scope", (MedicalSectionType.SCOPE.value,)),
    ("aim and scope", (MedicalSectionType.SCOPE.value,)),
    ("purpose and scope", (MedicalSectionType.SCOPE.value,)),
    ("范围", (MedicalSectionType.SCOPE.value,)),
    ("目的与范围", (MedicalSectionType.SCOPE.value,)),
    ("recommendations", (MedicalSectionType.RECOMMENDATIONS.value,)),
    ("recommendation", (MedicalSectionType.RECOMMENDATIONS.value,)),
    ("推荐", (MedicalSectionType.RECOMMENDATIONS.value,)),
    ("建议", (MedicalSectionType.RECOMMENDATIONS.value,)),
    ("evidence", (MedicalSectionType.EVIDENCE.value,)),
    ("证据", (MedicalSectionType.EVIDENCE.value,)),
    ("证据质量", (MedicalSectionType.EVIDENCE.value,)),
    ("contraindications", (MedicalSectionType.CONTRAINDICATIONS.value,)),
    ("contraindication", (MedicalSectionType.CONTRAINDICATIONS.value,)),
    ("禁忌证", (MedicalSectionType.CONTRAINDICATIONS.value,)),
    ("禁忌", (MedicalSectionType.CONTRAINDICATIONS.value,)),
    ("implementation", (MedicalSectionType.IMPLEMENTATION.value,)),
    ("实施", (MedicalSectionType.IMPLEMENTATION.value,)),
    ("实施建议", (MedicalSectionType.IMPLEMENTATION.value,)),
    ("monitoring", (MedicalSectionType.MONITORING.value,)),
    ("follow-up", (MedicalSectionType.MONITORING.value,)),
    ("监测", (MedicalSectionType.MONITORING.value,)),
    ("随访", (MedicalSectionType.MONITORING.value,)),
    ...
    ("acknowledgements", (MedicalSectionType.ACKNOWLEDGEMENTS.value,)),
    ("acknowledgments", (MedicalSectionType.ACKNOWLEDGEMENTS.value,)),
    ("致谢", (MedicalSectionType.ACKNOWLEDGEMENTS.value,)),
    ("致謝", (MedicalSectionType.ACKNOWLEDGEMENTS.value,)),
    ("author contributions", (MedicalSectionType.AUTHOR_CONTRIBUTIONS.value,)),
    ("author contribution", (MedicalSectionType.AUTHOR_CONTRIBUTIONS.value,)),
    ("作者贡献", (MedicalSectionType.AUTHOR_CONTRIBUTIONS.value,)),
    ("funding", (MedicalSectionType.FUNDING.value,)),
    ("financial support", (MedicalSectionType.FUNDING.value,)),
    ("资助", (MedicalSectionType.FUNDING.value,)),
    ("资金来源", (MedicalSectionType.FUNDING.value,)),
    ("conflict of interest", (MedicalSectionType.CONFLICTS_OF_INTEREST.value,)),
    ("conflicts of interest", (MedicalSectionType.CONFLICTS_OF_INTEREST.value,)),
    ("declaration of interests", (MedicalSectionType.CONFLICTS_OF_INTEREST.value,)),
    ("declarations of interest", (MedicalSectionType.CONFLICTS_OF_INTEREST.value,)),
    ("利益冲突", (MedicalSectionType.CONFLICTS_OF_INTEREST.value,)),
    ("references", (MedicalSectionType.REFERENCES.value,)),
    ("reference", (MedicalSectionType.REFERENCES.value,)),
    ...
    ("supplementary material", (MedicalSectionType.SUPPLEMENTARY.value,)),
    ("supplementary materials", (MedicalSectionType.SUPPLEMENTARY.value,)),
