...
class MedicalAnalysisRunRecord(Base):
    ...
    prompt_version: Mapped[str] = mapped_column(String(64), default="medical-insights-v3")
    schema_version: Mapped[str] = mapped_column(String(64), default="medical-insights-v3")
