...
def test_metrics_endpoint_records_route_labels():
    ...
    assert health.headers["x-graphmind-analysis-pipeline"] == "medical-insights-readable-v10"
    assert health.headers["x-graphmind-insight-contract"] == "medical-insights-readable-v9"
