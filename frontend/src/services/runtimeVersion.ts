export const EXPECTED_PARSER_VERSION = "document-parser-pdf-readable-v5";
export const EXPECTED_ANALYSIS_PIPELINE_VERSION = "medical-insights-readable-v5";
export const EXPECTED_INSIGHT_CONTRACT_VERSION = "medical-insights-readable-v5";
