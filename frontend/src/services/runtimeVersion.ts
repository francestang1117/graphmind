...
export const EXPECTED_ANALYSIS_PIPELINE_VERSION = "medical-insights-readable-v8";
export const EXPECTED_INSIGHT_CONTRACT_VERSION = "medical-insights-readable-v8";
